...
function setup() {
	...
	roofObject=new roof(width/2,height/4,200,20);

	bobDiameter=40;

	startBobPositionX=width/2;
	startBobPositionY=height/4+500;
	bobObject1=new bob(-30,300,bobDiameter);
	bobObject2=new bob(startBobPositionX-bobDiameter,350,bobDiameter);
	bobObject3=new bob(startBobPositionX,350,bobDiameter);
	bobObject4=new bob(startBobPositionX+bobDiameter,350,bobDiameter);
	bobObject5=new bob(startBobPositionX+bobDiameter*2,350,bobDiameter);
